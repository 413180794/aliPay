...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.set_title_pushButton = QtWidgets.QPushButton(self.logining_Widget)
        self.set_title_pushButton.setObjectName("set_title_pushButton")
        self.horizontalLayout.addWidget(self.set_title_pushButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_15.setText(_translate("MainWindow", "页面Title"))
        self.label_14.setText(_translate("MainWindow", "token值"))
        self.start_pushButton.setText(_translate("MainWindow", "开始"))
        self.set_title_pushButton.setText(_translate("MainWindow", "修改页面Title"))
